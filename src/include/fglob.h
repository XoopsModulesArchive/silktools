...
/*@unused@*/ static char rcsID_FGLOB_H[]
#ifdef __GNUC__
  __attribute__((__unused__))
#endif
  = "fglob.h,v 1.8 2003/12/10 22:00:41 thomasm Exp";
...
char *fglobNext(void);
int fglobSetGlobSpec(char *newSpecf);
int fglobValid(void);
...
int fglobSetClass(char *);
int fglobSetType(char *);
int fglobSetStartDate(char *);
int fglobSetEndDate(char *);
int fglobSetSensors(char *);
