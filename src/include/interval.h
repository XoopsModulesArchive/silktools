...
/*@unused@*/ static char rcsID_INTERVAL_H[]
#ifdef __GNUC__
  __attribute__((__unused__))
#endif
  = "interval.h,v 1.6 2003/12/10 22:00:44 thomasm Exp";
...
double * intervalQuartiles(uint32_t *data, uint32_t *intervals,
                           uint32_t numIntervals);
double * intervalMoments(uint32_t *data, uint32_t *intervals,
                         uint32_t numIntervals);
