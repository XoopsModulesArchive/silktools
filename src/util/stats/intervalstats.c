...
RCSIDENT("intervalstats.c,v 1.8 2004/03/10 22:23:52 thomasm Exp");
...
#else
static double getQuantile(uint32_t *UNUSED(data), uint32_t *boundaries,
                          uint32_t numIntervals, uint32_t quantile) {
  /*
...
double *intervalQuartiles(uint32_t *data, uint32_t *boundaries,
...
double *intervalMoments(uint32_t *data, uint32_t *UNUSED(boundaries),
                        uint32_t numIntervals) {
